            ...
            >
              <div className="flex items-center gap-2.5">
                ...
                <span className="text-xl font-extrabold text-white font-['Outfit',sans-serif] tracking-wider uppercase">
                  DR. DEEPAL'S <span className="text-[#FDE68A]">DENTAL CLINIC</span>
                </span>
              </div>
              ...
              <div className="flex items-center gap-2 text-amber-300 text-xs font-bold pt-1">
                ...
                <span className="font-['Outfit',sans-serif] font-black text-white">5.0 Verified · 84 Reviews on Google</span>
              </div>
            </motion.div>
