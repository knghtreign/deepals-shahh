            ...
            {cards.map((card, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="absolute w-[280px] sm:w-[390px] h-[240px] sm:h-[310px] rounded-[28px] sm:rounded-[34px] overflow-hidden bg-white p-2 sm:p-2.5 shadow-[0_20px_50px_rgba(15,23,42,0.12)] border-2 sm:border-3 border-amber-300 ring-1 ring-amber-200/50"
                  style={{
                    zIndex,
