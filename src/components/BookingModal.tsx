              ...
              {!isSubmitted ? (
                ...
                >
                  ...
                  <p className="text-xs sm:text-sm text-slate-600 font-medium mt-2 mb-6">
                    Thank you <strong className="text-[#C58B1B]">{patientName}</strong>. Dr. Deepal's team at Malabar Hill will confirm your {selectedService} slot ({preferredDate}, {preferredTime}) shortly at <strong className="text-[#C58B1B]">{phone}</strong>.
                  </p>

                  <div className="bg-slate-50 p-4 rounded-2xl border border-slate-200 text-left text-xs text-slate-600 space-y-1 mb-6">
                    <p className="font-bold text-[#0F172A]">📍 Dr. Deepal's Dental Clinic</p>
                    <p>Shop No. 9, Gate No. 2, L.D. Ruparel Marg, Malabar Hill, Mumbai</p>
                    <p className="text-[#C58B1B] font-bold">📞 Direct Clinic Line: 079777 76136</p>
                  </div>
